...
const Home = () => {
  const homewwd = [
    ...
    },
    {
      ...
      wwdInfo: "Creating professional websites for businesses and portfolios.",
    },
    {
            ...
            return (
              <>
                <div class="card w-1/3 p-10 bg-">
                  ...
                  />
                  <h2 class="text-center text-xl mb-2">{props.wwdHead}</h2>
                  <p class="text-center text-gray-400">{props.wwdInfo}</p>
                </div>
              </>
            );
          })}
